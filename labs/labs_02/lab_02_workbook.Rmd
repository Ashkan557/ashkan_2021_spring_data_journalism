...
arcos_wv_mingo 
<- read_csv("data/arcos-wv-mingo-54059-pharmacy.csv")
...
```{r}
# Answer to question 1: # Giant Pharmacy 166, 10,365
arcos_md_baltimorecity_sorted<-
arcos_md_baltimorecity_trimmed %>%
...
```{r}
# Answer to question 2: OSHINSKY, ALAN E MD and JAKOBOVITS, JULIAN MD both have 4. In terms of an actual pharmacy NIA Research Pharmacy had the least with 100.
arcos_md_baltimorecity_sorted<-
arcos_md_baltimorecity_trimmed %>%
arrange(desc(total_dosage_unit))
