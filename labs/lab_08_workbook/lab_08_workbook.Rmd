...
#A: column names are messed up worded weird with a lot of periods, also some states do not have any data recorded. Also a N/A row. Also when you glimpse they're character columns and well those names do not make sense. 
