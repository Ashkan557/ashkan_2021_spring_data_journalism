...
```{r}
#Louisiana had the highest number of COVID-19 cases per 1,000 on August 30.
covid_state_2020_08_30.csv <- state_covid_population %>%
...
```{r}
#Hawaii had the lowest number of COVID-19 deaths per 1,000 on August 30. 
covid_state_2020_08_30.csv <- state_covid_population %>%
